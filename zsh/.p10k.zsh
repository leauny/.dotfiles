# Generated by Powerlevel10k configuration wizard on 2022-05-15 at 11:05 CST.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 56598.
# Wizard options: nerdfont-complete + powerline, small icons, rainbow, unicode,
# 24h time, angled separators, round heads, sharp tails, 2 lines, dotted, left frame,
...
() {
  ...
  typeset -g POWERLEVEL9K_TIME_FORMAT='%D{%H:%M}' #'%D{%H:%M:%S}'
  ...
  typeset -g POWERLEVEL9K_TRANSIENT_PROMPT=same-dir # 修改提示类型
